...
public class PacManView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mPaint.setColor(Color.parseColor("#8c000000"));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        // 算出宽度
        mWidth = measureSize(widthMeasureSpec, mMetrics.widthPixels + getPaddingLeft() + getPaddingRight());
        mPaint.setStrokeWidth(mWidth * 1.0f / 100);

        mPacManRadius = (int) (mWidth * 1.0f / 25);
